...
const BlogItem = ({ src, title, date, view }) => {
  return (
    <section className="bg-white flex flex-col items-center w-max px-5 py-5 drop-shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-[#FF6230]/30 hover:shadow-md">
