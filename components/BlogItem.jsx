...
const BlogItem = ({ src, title, date, view }) => {
  return (
    <Link href="/posts" passHref>
      <section className="bg-white cursor-pointer flex flex-col items-center w-full px-5 py-5 drop-shadow-lg transition-all duration-300 z-10 hover:scale-105 hover:shadow-[#FF6230]/30 hover:shadow-lg hover:z-20">
