      ...
      <div className="w-11/12">
        ...
        <div className="mt-8 flex flex-row">
          <div className="flex flex-col gap-10">
            <ParentItem title="ابزار و تجهیزات صنعتی" src={paintSVG} />
            <ParentItem title="مد و پوشاک" src={paintSVG} />
            <ParentItem title="کالا های سوپر مارکتی" src={bagSVG} />
            <ParentItem title="اسباب بازی و کودک" src={lifegaurdSVG} />
            <ParentItem title="خانه و آشپز خانه" src={bellAlt} />
            <ParentItem title="ورزش و سفر" src={workSVG} />
            <ParentItem title="محصولات بومی و محلی" src={treeSVG} />
            <ParentItem title="زیبایی و سلامت" src={heartSVG} />
            <ParentItem title="کتاب و لوازم تحریر" src={bookAltSVG} />
          </div>
...
const ParentItem = ({ title, icon, src }) => {
  return (
    <div className="flex flex-row items-center cursor-pointer transition-transform duration-300 hover:scale-105">
      {icon ? (
        icon
      ) : src ? (
