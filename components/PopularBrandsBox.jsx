...
const PopularBrandsBox = ({ src, count, rate }) => {
  return (
    <div className="group cursor-pointer bg-white w-full flex flex-col items-center px-7 py-5 transition-all duration-300 drop-shadow-md scale-90 hover:drop-shadow-xl hover:scale-105 hover:shadow-[#FF6230]/40 hover:shadow-xl">
      <div>
        <Image
          loading="eager"
          src={src}
