...
const PopularBrandsBox = ({ src, count, rate }) => {
  return (
    <div className="group cursor-pointer bg-white w-max px-7 py-5 rounded-lg transition-all duration-300 drop-shadow-md hover:drop-shadow-xl hover:scale-105 hover:shadow-[#FF6230]/40 hover:shadow-md">
      <div>
        <Image src={src} width={160} height={160} alt="Brands icon" />
      </div>
